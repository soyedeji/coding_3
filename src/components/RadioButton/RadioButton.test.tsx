...
describe('RadioButton Component', () => {
  test('renders the radio button with label', () => {
    render(<RadioButton label="Option 1" name="radio-group" value="option-1" />);
  ...
  test('calls onChange when clicked', () => {
    ...
    render(<RadioButton label="Option 1" name="radio-group" value="option-1" onChange={handleChange} />);
  ...
  test('radio button is checked when checked prop is true', () => {
    render(<RadioButton label="Option 2" name="radio-group" value="option-2" checked={true} />);
